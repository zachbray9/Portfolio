    ...
    return (
        <footer className="flex flex-col sm:flex-row-reverse items-center justify-center sm:justify-between pb-32">
            <div className="flex items-center gap-4">
                <SocialLink url="https://linkedin.com/in/zach-bray" Icon={FaLinkedin} className="text-muted hover:text-black dark:hover:text-white"/>
                <SocialLink url="https://github.com/zachbray9" Icon={FaGithub} className="text-muted hover:text-black dark:hover:text-white"/>
